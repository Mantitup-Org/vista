...
/** Server-safe ThemeScript — avoids importing vista/theme (which pulls createContext into RSC). */
export function ThemeScript({ defaultTheme = 'system' }: { defaultTheme?: ThemeMode }) {
  return (
    <script
