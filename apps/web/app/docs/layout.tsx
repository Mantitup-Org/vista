...
export default function DocsLayout({ children }: DocsLayoutProps) {
  ...
  return (
    <main className="min-h-screen bg-background pb-20 pt-20 text-foreground selection:bg-primary/20 selection:text-primary">
      ...
      <div className="mx-auto mt-4 w-full max-w-[1400px] min-h-[calc(100vh-9rem)]">
        <div className="grid grid-cols-1 lg:grid-cols-[290px_minmax(0,1fr)] xl:grid-cols-[290px_minmax(0,1fr)_240px]">
          <aside className="hidden self-start border-r border-foreground/10 lg:sticky lg:top-20 lg:block">
          ...
          <aside className="hidden border-l border-foreground/10 px-4 py-6 xl:block">
