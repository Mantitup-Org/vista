...
const listeners = new Set<(observation: AgentObservation) => void>();

export function onAgentObservation(listener: (observation: AgentObservation) => void): () => void {
...
export function emitAgentObservation(observation: AgentObservation): void {
